...
export default function WebRecorder(options = { saveBlobs: false }) {
  // Video Part
  ...
  async function startRecording(stream) {
    ...
    mediaRecorder.start(options.timeSlice || 100) // collect 100ms of data blobs
    isRecording = true
  ...
  function handleDataAvailable(event) {
    ...
    if (!options.saveBlobs && event.data && event.data.size > 0) {
